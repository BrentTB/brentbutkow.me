...
export const recallRadarCopy = {
  ...
  methodology:
    "Sources: US openFDA + USDA FSIS, the Canadian Food Inspection Agency, UK Food Standards Agency alerts, the EU's Rapid Alert System for Food and Feed (RASFF), and South Africa's National Consumer Commission notices. Each recall's cause comes from matching its own wording against a curated gazetteer of regulated allergens and named pathogens.",
  about:
...
export const methodologyPoints: string[] = [
  ...
  'Allergens, pathogens, and physical hazards are pulled from each reason text with a curated gazetteer — the FDA, CFIA, and UK regulated allergen lists, plus named pathogens. The hazard it finds also sets the cause, so the pathogen in "raw milk cheese recalled for E. coli" decides the category rather than the ingredient. Deterministic and fully explainable.',
