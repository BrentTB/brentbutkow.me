...
// The themes (embedding clusters) for a country, built offline by build_analytics. Themes are
// per-country — US and UK recall structures differ — so this refetches when the country changes.
