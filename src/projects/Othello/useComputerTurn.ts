...
/** A beat to let your own move — and its flip cascade — paint before the search takes the thread. */
const PAINT_DELAY_MS = 32

/** What the hard tier may spend searching: the thinking window, less the paint beat. */
